			...
			<div class="container-fluid">
				...
				<div class="row">
					<form class="form-horizontal form-material" method="post"
						action="/projetoweb/livros/cadastrar">
						<div class="col-md-4 col-xs-12">
							<div class="white-box">
									...
									<div class="overlay-box">
										<div class="user-content">
											<a href="javascript:void(0)"><img
												src="/projetoweb/images/books/livro.png" class="thumb-lg"
												alt="img"></a>
								...
								<div class="user-btm-box">
									...
									<div class="col-md-12">
										<input type="text" name="imagem" data-ls-module="charCounter"
											maxlength="50" class="form-control form-control-line">
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-8 col-xs-12">
							<div class="white-box">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="nome" data-ls-module="charCounter"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="autor" data-ls-module="charCounter"
											maxlength="100" required="required"
											class="form-control form-control-line">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<textarea rows="5" name="descricao" required="required"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="isbn" required="required"
											data-ls-module="charCounter" maxlength="25"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="quantidade" required="required"
											data-ls-module="charCounter" maxlength="9"
											class="form-control form-control-line">
									</div>
								</div>
